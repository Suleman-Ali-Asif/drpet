...
const Navbar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 flex flex-col items-center ${isScrolled ? "bg-white shadow-md" : "bg-white"
        }`}
    >
