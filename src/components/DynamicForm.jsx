            ...
            return (
                <div className='md:flex md:items-center mb-6'>
                    <div className='w-full text-right'>
                        <Link to='/auth/forgot-password' className='text-blue-500 font-semibold hover:underline'>
                            Forgot Password?
                        </Link>
                    </div>
                </div>
                            ...
                            {otp.map((value, index) => (
                                <div key={index} className='flex flex-col items-left'>
                                    <input
                                        ...
                                        value={value || ''}
                                        onChange={(event) => handleChange(event, 'otp', false, index)}
                                    />
                                </div>
                            ))}
                        </div>
        ...
        case 'button':
            return (
                <div className='md:flex md:items-center'>
                    <button className='w-1/4 shadow bg-blue-600 hover:bg-dark-green 
                    focus:shadow-outline focus:outline-none text-white  
                    py-3 px-4 rounded-md' type='submit'>
                        {buttonText}
                    </button>
                </div>
            );
