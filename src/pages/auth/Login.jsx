  ...
  return (
    <div>
      {loading ? (
        ...
        <div
          className="flex flex-col sm:flex-row  justify-between items-stretch 
          ...
          >
            <h2
              className="w-full max-w-sm text-2xl sm:text-2xl md:text-2xl lg:text-3xl 
                        text-left font-semibold mt-8 mb-2"
            >
              Log in
            </h2>
            <p className="w-full max-w-sm text-left text-gray-500">
              Clarity gives you the blocks and components need to create a truly
