...
const Contact = () => {
    ...
    const fields = [
        { type: 'text', name: 'first_name', placeholder: 'First name', isRow: true, customMargins: 'mr-2',  },
        { type: 'text', name: 'last_name', placeholder: 'Last name', isRow: true, customMargins: 'ml-2',  },
        { type: 'email', name: 'email', placeholder: 'Email' },
        { type: 'tel', name: 'phone', placeholder: 'Phone number' },
        {type: 'textarea', name: 'message', placeholder: 'Message' },
        { type: 'checkbox', name: 'agree', text: 'You agree to our friendly <a href="/" class="text-blue font-semibold underline">privacy policy.</a>'  },
            ...
            <section className='md:flex space-x-8 px-12 py-12 md:px-36 md:mb-0'>
                <div className='w-full md:w-4/12 text-left'>
                    <div className='rounded-md border-2 border-gray-300 
                        ...
                        <FaPhone className='text-green mr-6' 
                            size={20} 
                        />
                        <div>
                ...
                <div className='w-full md:w-4/12 text-left'>
                    <div className='rounded-md border-2 border-gray-300 
                        border-dashed p-6 flex items-center h-24'>
                        <FaEnvelope className='text-green mr-6' 
                            size={20}
                        />
                        <div>
                ...
                <div className='w-full md:w-4/12 text-left'>
                    <div className='rounded-md border-2 border-gray-300 
                        ...
                        <FaMapMarkerAlt className='text-green mr-6' 
                            size={28}
                        />
                        <div>
                            <p className='font-semibold mb-2'>Address</p>
                            <p className='text-xs'>Al Abraj , Block – A 3rd Floor Room 306 – Al Ittihad Rd
                            – Al Mamzar – Dubai</p>
                        </div>
                    </div>
                </div>
